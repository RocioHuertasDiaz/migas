                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="col-xl-12 grid-margin">
                            <form class="card"
                                  ...
                                  method="post">
                                <div class="card-body">
                                    <h4 class="card-title">Registro de Insumo</h4>
                                    ...
                                    <form class="form-sample">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label" for="idInsumo">ID
                                                        Insumo</label>
                                                    <div class="col-sm-9">
                                                        <input
                                                                id="idInsumo"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label" for="nombreInsumo">Nombre del
                                                        Insumo</label>
                                                    <div class="col-sm-9">
                                                        <input
                                                                id="nombreInsumo"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label" for="cantidadInsumo">Cantidad
                                                        Insumo</label>
                                                    <div class="col-sm-9">
                                                        <input
                                                                id="cantidadInsumo"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label" for="fechaIngreso">Fecha
                                                        de
                                                        ingreso</label>
                                                    <div class="col-sm-9">
                                                        <input
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label" for="fechaVencimiento">Fecha
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label" for="loteInsumo">Lote
                                                        Insumo</label>
                                                    <div class="col-sm-9">
                                                        <input
                                                                id="loteInsumo"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label" for="precioUnitario">Precio
                                                        Unitario</label>
                                                    <div class="col-sm-9">
                                                        <input
                                                                id="precioUnitario"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label" for="documentoProveedor">Documento
                                                        Proveedor: </label>
                                                    <div class="col-sm-9">
                                                        <input
