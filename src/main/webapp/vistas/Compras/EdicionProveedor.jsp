                ...
                <div class="row">
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="col-xl-12 grid-margin">
                            <form class="card"
                                  action="http://localhost:8080/migas_war_exploded/Proveedor?opcion=editar"
                                  method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <label class="col-sm-3 col-form-label" for="razonSocialProveedor">Nombre del Proveedor:</label>
                                                    <div class="col-sm-9">
                                                        <input type="date" class="form-control" name="razonSocialProveedor"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label" for="nombreContactoProveedor">Nombre Contacto:</label>
                                                    <div class="col-sm-9">
                                                        <input type="date" class="form-control" name="nombreContactoProveedor"
