...
<head>
  ...
  <title>Sistema de información| Error</title>
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="http://localhost:8080/migas_war_exploded/ServletUsuario?opcion=verificar"><i class="fa fa-dashboard"></i> Inicio</a></li>
