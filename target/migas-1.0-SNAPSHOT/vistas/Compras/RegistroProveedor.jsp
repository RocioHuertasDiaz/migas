                ...
                <div class="row">
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="col-xl-12 grid-margin">
                            <form class="card"
                                  action="http://localhost:8080/migas_war_exploded/Proveedor?opcion=guardar"
                                  method="post">
                                <div class="card-body">
                                    ...
                                    <form class="form-sample">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label" for="nitProveedor">Nit
                                                        Proveedor:</label>
                                                    <div class="col-sm-9">
                                                        <input
                                                                id="nitProveedor"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label" for="razonSocialProveedor">Razón
                                                        Social:</label>
                                                    <div class="col-sm-9">
                                                        <input
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label"
                                                           for="nombreContactoProveedor">Nombre Contacto:</label>
                                                    <div class="col-sm-9">
                                                        <input
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label" for="emailProveedor">Correo
                                                        Proveedor:</label>
                                                    <div class="col-sm-9">
                                                        <input
                                                                id="emailProveedor"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label" for="direccionProveedor">Dirección
                                                        Proveedor:</label>
                                                    <div class="col-sm-9">
                                                        <input
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label"
                                                           for="telefonoProveedor">Teléfono Proveedor:</label>
                                                    <div class="col-sm-9">
                                                        <input
